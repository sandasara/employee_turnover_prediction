...
class LinkedInPeopleProfileSpider(scrapy.Spider):
    ...
    custom_settings = {
         'FEEDS': { 'data/scraped_people_data/%(name)s_%(time)s.json': { 'format': 'json' }}
    }
    ...
    profile_list = list(profiles_to_scrape)
    ...
    def start_requests(self):
        for profile in profile_list:
            ...
            yield scrapy.Request(
                ...
                meta={'profile': profile, 'linkedin_url': proxy_url})
            time.sleep(2)
